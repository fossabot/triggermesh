...
// newEventTarget returns a test DatadogTarget object with pre-filled attributes.
func newEventTarget() *v1alpha1.DatadogTarget {
	o := &v1alpha1.DatadogTarget{
		...
		Spec: v1alpha1.DatadogTargetSpec{
			DatadogAPIKey: v1alpha1.SecretValueFromSource{
...
// Deployed: True
func newEventTargetDeployed() *v1alpha1.DatadogTarget {
	o := newEventTarget()
...
// Deployed: False
func newEventTargetNotDeployed() *v1alpha1.DatadogTarget {
	o := newEventTarget()
		...
		ObjectMeta: metav1.ObjectMeta{
			...
			OwnerReferences: []metav1.OwnerReference{
				*kmeta.NewControllerRef(NewOwnerRefable(
					tName,
					(&v1alpha1.DatadogTarget{}).GetGroupVersionKind(),
					tUID,
				)),
			},
		},
