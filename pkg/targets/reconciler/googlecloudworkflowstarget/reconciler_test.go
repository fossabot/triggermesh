...
// newEventTarget returns a test GoogleCloudWorkflowsTarget object with pre-filled attributes.
func newEventTarget() *v1alpha1.GoogleCloudWorkflowsTarget {
	o := &v1alpha1.GoogleCloudWorkflowsTarget{
...
// Deployed: True
func newEventTargetDeployed() *v1alpha1.GoogleCloudWorkflowsTarget {
	o := newEventTarget()
...
// Deployed: False
func newEventTargetNotDeployed() *v1alpha1.GoogleCloudWorkflowsTarget {
	o := newEventTarget()
		...
		ObjectMeta: metav1.ObjectMeta{
			...
			OwnerReferences: []metav1.OwnerReference{
				*kmeta.NewControllerRef(NewOwnerRefable(
					tName,
					(&v1alpha1.GoogleCloudWorkflowsTarget{}).GetGroupVersionKind(),
					tUID,
				)),
			},
		},
								...
								Env: []corev1.EnvVar{
									{
										...
										Value: "googlecloudworkflowstarget-" + tName,
									}, {
										Name: "GOOGLE_WORKFLOWS_CREDENTIALS_JSON",
