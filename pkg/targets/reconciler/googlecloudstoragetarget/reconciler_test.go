...
// newEventTarget returns a test GoogleCloudStorageTarget object with pre-filled attributes.
func newEventTarget() *v1alpha1.GoogleCloudStorageTarget {
	o := &v1alpha1.GoogleCloudStorageTarget{
...
// Deployed: True
func newEventTargetDeployed() *v1alpha1.GoogleCloudStorageTarget {
	o := newEventTarget()
...
// Deployed: False
func newEventTargetNotDeployed() *v1alpha1.GoogleCloudStorageTarget {
	o := newEventTarget()
		...
		ObjectMeta: metav1.ObjectMeta{
			...
			OwnerReferences: []metav1.OwnerReference{
				*kmeta.NewControllerRef(NewOwnerRefable(
					tName,
					(&v1alpha1.GoogleCloudStorageTarget{}).GetGroupVersionKind(),
					tUID,
				)),
			},
		},
								...
								Env: []corev1.EnvVar{
									{
										...
										Value: "googlecloudstoragetarget-" + tName,
									}, {
