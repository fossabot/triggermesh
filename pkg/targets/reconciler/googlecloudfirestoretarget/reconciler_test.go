...
// newEventTarget returns a test GoogleCloudFirestoreTarget object with pre-filled attributes.
func newEventTarget() *v1alpha1.GoogleCloudFirestoreTarget {
	o := &v1alpha1.GoogleCloudFirestoreTarget{
		...
		Spec: v1alpha1.GoogleCloudFirestoreTargetSpec{
			...
			Credentials: v1alpha1.SecretValueFromSource{
...
// Deployed: Unknown
func newEventTargetUnknownDeployed(adapterExists bool) *v1alpha1.GoogleCloudFirestoreTarget {
	o := newEventTarget()
...
// Deployed: True
func newEventTargetDeployed() *v1alpha1.GoogleCloudFirestoreTarget {
	o := newEventTarget()
...
// Deployed: False
func newEventTargetNotDeployed() *v1alpha1.GoogleCloudFirestoreTarget {
	o := newEventTarget()
		...
		ObjectMeta: metav1.ObjectMeta{
			...
			OwnerReferences: []metav1.OwnerReference{
				*kmeta.NewControllerRef(NewOwnerRefable(
					tName,
					(&v1alpha1.GoogleCloudFirestoreTarget{}).GetGroupVersionKind(),
					tUID,
				)),
			},
		},
								...
								Env: []corev1.EnvVar{
									{
										...
										Value: "googlecloudfirestoretarget-" + tName,
									}, {
										Name:  "GOOGLE_FIRESTORE_DEFAULT_COLLECTION",
										Value: tCollection,
									}, {
										Name:  "EVENTS_BRIDGE_IDENTIFIER",
										Value: "",
									}, {
